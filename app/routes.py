...
from app.forms import LoginForm, EmptyForm, RegistrationForm, EditProfileForm, PostForm
...
def index () -> None:
    ...
    next_url = url_for ("index", page=posts.prev_num) \
...
def register ():
    ...
    if form.validate_on_submit ():
        ...
        db.session.add (user);
        db.session.commit ();
        flash ("Congratulasions you are now a new user in our community");
...
def edit_profile ():
    form: EditProfileForm = EditProfileForm (current_user.username);
    if form.validate_on_submit ():
        current_user.username = form.username.data;
        current_user.about_me = form.about_me.data;
        db.session.commit ();
        flash ("Your changes have been saved to database");
